...
List<GameCard> gettingStarted = [
  GameCard(
      ...
      elements: 0),
  GameCard(
      firstLine: '{{0}}, do what {{1}} tells you to do or drink {[0]} times.',
  ...
  GameCard(
      ...
      secondLine: "No more drinking when someone speaks!",
  ...
  GameCard(
      ...
      secondLine: 'Shy-guy can answer questions again.',
      cardType: CardType.virus,
      players: 1,
      elements: 0),
  GameCard(
      firstLine: '{{0}} drink {[0]} times.',
      cardType: CardType.rule,
      players: 1,
      elements: 1),
  GameCard(
...
{{0}} give a dare to {{1}}. If she or he completes it, she or he can give out {[0]} sips.''',
      ...
      elements: 1),
  GameCard(
      firstLine: 'Drink {[0]} sips if you have ever vomited out of a window.',
      cardType: CardType.rule,
      players: 0,
      elements: 1),
  GameCard(
  ...
  GameCard(
      ...
      elements: 1),
  GameCard(
      firstLine: '{{0}}, give {{1}} 2 euros or down your drink.',
      cardType: CardType.bottomsUp,
      players: 2,
      elements: 0),
  GameCard(
  ...
  GameCard(
      firstLine:
          '{{0}}, does {{1}} have a sister? Drink 2 times if you\'re wrong, give out 2 sips if you\'re right.',
      cardType: CardType.rule,
      players: 2,
      elements: 0),
  GameCard(
  ...
  GameCard(
      firstLine:
          '"Movies where an American hero walks towards the camera as something explodes behind him", the first to run out of ideas drinks {[0]} time. {{0}} you start.',
      cardType: CardType.game,
      players: 1,
      elements: 1),
  GameCard(
  ...
  GameCard(
      ...
      elements: 0),
  GameCard(
      firstLine: "Drink {[0]} time if you've ever taken someone's virginity.",
      cardType: CardType.rule,
      players: 0,
      elements: 1),
  GameCard(
  ...
  GameCard(
      firstLine:
          'Would you rather go to prison for 6 months or live alone for a whole year? Vote at the same time, losers drink {[0]} time.',
      cardType: CardType.game,
      players: 0,
      elements: 1),
  GameCard(
      firstLine: 'People who smoke, drink {[0]} time.',
      cardType: CardType.rule,
      players: 0,
      elements: 1),
  GameCard(
      firstLine: 'Drink {[0]} time if you have nudes on your phone.',
      cardType: CardType.rule,
      players: 0,
      elements: 1),
  GameCard(
